...
namespace CustomCrypto
{
    public class ECDHWrapper
    {
        ...
        public ECDHWrapper(int newagrlen)
        {
            ...
            pu1 = (DHPublicKeyParameters)pair.Public;
            pv1 = (DHPrivateKeyParameters)pair.Private;
        ...
        private void initPG(int newagrlen)
        {
            switch (newagrlen)
            {
                ...
                case 96:
                    //768 bits
                    p=new BigInteger("8c9dd223debed1b80103b8b309715be009d48860ed5ae9b9d5d8159508efd802e3ad4501a7f7e1cfec78844489148cd72da24b21eddd01aa624291c48393e277cfc529e37075eccef957f3616f962d15b44aeab4039d01b817fde9eaa12fd73f", 16);
                    g=new BigInteger("7c240073c1316c621df461b71ebb0cdcc90a6e5527e5e126633d131f87461c4dc4afc60c2cb0f053b6758871489a69613e2a8b4c8acde23954c08c81cbd36132cfd64d69e4ed9f8e51ed6e516297206672d5c0a69135df0a5dcf010d289a9ca1", 16);
                    break;
                case 128:
                    //1024 bits
                    p=new BigInteger("", 16);
                    g=new BigInteger("", 16);
                    break;
                default:
        ...
        {
            int hdrSize = 8;
            Byte[] bY = pu1.Y.ToByteArray();
            Byte[] bm1 = m1.ToByteArray();
        ...
        public byte[] calcAgreementDef(Byte[] pubdata)
        {
            ...
            DHParameters newDHParameters = new DHParameters(p, g);
            DHPublicKeyParameters pu2 = new DHPublicKeyParameters(Y2, newDHParameters);
            return e1.CalculateAgreement(pu2, m2).ToByteArray();//Variable length (not necessary bits / 8)            
        }
